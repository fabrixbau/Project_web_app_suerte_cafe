(function () {
  ...
  function selectProfile(card, moveFocus) {
    ...
    cards.forEach(function (item) {
      ...
      if (selected) item.classList.add("is-selected");else item.classList.remove("is-selected");
    ...
    passwordHelp.textContent = requiresPassword ? "Este perfil necesita contraseña." : "Este perfil puede entrar sin contraseña.";
    if (moveFocus) {
